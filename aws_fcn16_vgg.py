...
class FCN16VGG:
    def __init__(self, layer_shapes,vgg16_npy_path):
        ...
        self.wd = 5e-4
        self.fc6_shape = layer_shapes[0]
        self.fc7_shape = layer_shapes[1]
        self.fc8_shape = layer_shapes[2]
    ...
    def build(self, rgb, train=False, num_classes=2, random_init_fc8=False,
        ...
        self.fc6 = self._pruned_fc6(self.pool5,self.fc6_shape,[7,7,512,4096],'fc6',filt_size=[7,7])
        if train:
            self.fc6 = tf.nn.dropout(self.fc6, 0.5)

        self.fc7 = self._pruned_fc(self.fc6 ,self.fc7_shape,[1,1,4096,4096],'fc7')
        if train:
        ...
        if random_init_fc8:
            ...
            self.score_fr = self._pruned_fc(self.fc7,self.fc8_shape,[1,1,4096,1000],'score_fr',relu=False)
